...
│   └── types/index.ts
├── public/                     # brand assets: promoter-os-mark.png (star, dark bg), -mark-blue.png (star, white bg),
│                               #   promoter-os-wordmark.png (custom lettering, white), -wordmark-dark.png, promoter-os-lockup.png, favicon.png
├── supabase/
