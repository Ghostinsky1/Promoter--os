    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {ticketTiers.map((tier, index) => (
          <div key={index} className="bg-[#0B0D12] border border-gray-700 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#14171E] border border-gray-600 text-white placeholder:text-gray-600 rounded-xl focus:ring-2 focus:ring-[#8FD3FF] focus:border-[#8FD3FF]"
                />
              </div>
              ...
              <div>
                ...
                <div className="px-4 py-3 bg-[#22262F] border border-gray-700 rounded-xl text-white font-semibold">
            ...
            <div className="mt-4 pt-4 border-t border-gray-700 flex justify-between items-center">
              ...
              <span className="font-semibold text-lg text-[#8FD3FF]">
      ...
      <button
        type="button"
        onClick={addTier}
        className="w-full py-4 border-2 border-dashed border-gray-700 rounded-2xl text-gray-400 hover:border-[#8FD3FF] hover:text-[#8FD3FF] hover:bg-[#8FD3FF]/5 transition-colors flex items-center justify-center gap-2 font-medium"
      >
      ...
      <div className="bg-gradient-to-r from-[#8FD3FF]/10 to-[#8FD3FF]/5 border-2 border-[#8FD3FF]/30 rounded-2xl p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="border-t-2 border-[#8FD3FF]/30 pt-4 flex justify-between items-center">
            ...
            <span className="text-2xl font-bold text-[#8FD3FF]">{formatCurrency(netGross)}</span>
          </div>
        </div>
      </div>
    </div>
