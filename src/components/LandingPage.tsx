...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F1113]">
      <nav className="fixed top-0 w-full bg-[#1A1D1F]/95 backdrop-blur-lg border-b border-gray-800 z-50 animate-[slideDown_0.5s_ease-out]">
      ...
      <section className="pt-8 md:pt-16 pb-8 md:pb-16 px-4 md:px-6 relative overflow-hidden">
        <div className="absolute inset-0 opacity-0 animate-[fadeIn_2s_ease-out_0.5s_forwards]">
          ...
          <Mic className="absolute top-[15%] left-[10%] w-16 h-16 md:w-24 md:h-24 text-[#C4FF0D] opacity-5 animate-[float_6s_ease-in-out_infinite]" style={{ animationDelay: '0s' }} />
          <Guitar className="absolute top-[25%] right-[15%] w-20 h-20 md:w-32 md:h-32 text-[#C4FF0D] opacity-5 animate-[float_8s_ease-in-out_infinite] rotate-12" style={{ animationDelay: '1s' }} />
          <Ticket className="absolute top-[45%] left-[8%] w-14 h-14 md:w-20 md:h-20 text-[#C4FF0D] opacity-5 animate-[float_7s_ease-in-out_infinite] -rotate-12" style={{ animationDelay: '2s' }} />
          <Music className="absolute top-[60%] right-[12%] w-16 h-16 md:w-24 md:h-24 text-[#C4FF0D] opacity-5 animate-[float_9s_ease-in-out_infinite]" style={{ animationDelay: '0.5s' }} />
          <Radio className="absolute top-[35%] right-[8%] w-12 h-12 md:w-16 md:h-16 text-[#C4FF0D] opacity-5 animate-[float_7s_ease-in-out_infinite] rotate-45" style={{ animationDelay: '1.5s' }} />
          <Disc className="absolute top-[20%] left-[20%] w-14 h-14 md:w-20 md:h-20 text-[#C4FF0D] opacity-5 animate-[float_10s_ease-in-out_infinite]" style={{ animationDelay: '2.5s' }} />
          <Users className="absolute top-[50%] left-[15%] w-16 h-16 md:w-24 md:h-24 text-[#C4FF0D] opacity-5 animate-[float_8s_ease-in-out_infinite] -rotate-6" style={{ animationDelay: '3s' }} />
          <Star className="absolute top-[10%] right-[25%] w-12 h-12 md:w-16 md:h-16 text-[#C4FF0D] opacity-5 animate-[float_6s_ease-in-out_infinite] rotate-12" style={{ animationDelay: '1s' }} />
          <DollarSign className="absolute top-[55%] right-[20%] w-14 h-14 md:w-20 md:h-20 text-[#C4FF0D] opacity-5 animate-[float_7.5s_ease-in-out_infinite]" style={{ animationDelay: '2s' }} />
        </div>

        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-block mb-8 px-6 py-3 bg-[#252A2E] rounded-full border border-gray-800 animate-[fadeIn_0.6s_ease-out]">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-6 text-white leading-tight animate-[fadeIn_0.8s_ease-out_0.2s_both]">
              Know Your{' '}
              <span
                className="inline-block bg-gradient-to-r from-[#C4FF0D] via-[#E8FF66] to-[#C4FF0D] bg-clip-text text-transparent animate-[shimmer_3s_ease-in-out_infinite]"
                style={{
            ...
            <p className="text-base sm:text-lg text-[#A8B3B8] mb-8 max-w-3xl mx-auto leading-relaxed animate-[fadeIn_0.8s_ease-out_0.4s_both]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 animate-[fadeIn_0.8s_ease-out_0.6s_both]">
              <button
                onClick={() => navigate('/signup')}
                className="bg-[#C4FF0D] text-black hover:bg-[#A3D60A] text-lg px-10 py-7 rounded-2xl font-bold transition-all hover:scale-105 active:scale-95"
              >
                Start Free Trial →
              </button>
              <button
                onClick={() => navigate('/login')}
                className="border-2 border-gray-700 text-white hover:bg-[#252A2E] text-lg px-10 py-7 rounded-2xl transition-all hover:scale-105 active:scale-95"
              >
                See How It Works
              </button>
            </div>

            <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-[#A8B3B8]">
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="h-4 w-4 text-[#C4FF0D]" />
          ...
          <div className="mt-8 md:mt-12 relative animate-[fadeIn_1s_ease-out_0.8s_both]">
            <div className="relative rounded-2xl md:rounded-3xl overflow-hidden border-2 md:border-4 border-gray-800 shadow-2xl hover:shadow-[#C4FF0D]/20 hover:shadow-3xl transition-shadow duration-500">
              <div className="bg-[#1A1D1F] p-3 sm:p-6 md:p-8">
                <div className="bg-[#252A2E] rounded-xl md:rounded-2xl shadow-xl p-3 sm:p-6 md:p-8 border border-gray-800">
                  <div className="flex items-center justify-between mb-4 md:mb-6">
                    ...
                    <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-1 md:py-1.5 bg-[#C4FF0D]/10 rounded-lg border border-[#C4FF0D]/30">
                      <Sparkles className="h-2.5 w-2.5 md:h-3 md:w-3 text-[#C4FF0D]" />
                      <span className="text-[10px] md:text-xs font-semibold text-[#C4FF0D]">AI ANALYSIS</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-4">
                    <div className="lg:col-span-7 space-y-2 md:space-y-3">
                      <div className="flex items-center justify-between flex-wrap gap-2">
                        <div className="flex items-center gap-2 md:gap-3">
                          <Music className="h-4 w-4 md:h-5 md:w-5 text-[#C4FF0D] flex-shrink-0" />
                          <div>
                            <h3 className="text-white font-bold text-xs md:text-sm">The Midnight - Summer Tour 2025</h3>
                            <p className="text-[#A8B3B8] text-[10px] md:text-xs">The Wiltern, Los Angeles</p>
                          </div>
                        </div>
                      ...
                      <div className="bg-[#1A1D1F] rounded-lg md:rounded-xl p-3 md:p-4 border border-gray-700">
                        <div className="grid grid-cols-3 gap-2 md:gap-3 mb-3 md:mb-4">
                          <div>
                            <p className="text-[#A8B3B8] text-[10px] md:text-xs mb-1">Deal Type</p>
                            <p className="text-white font-semibold text-xs md:text-sm">Guarantee vs %</p>
                          </div>
                          <div>
                            <p className="text-[#A8B3B8] text-[10px] md:text-xs mb-1">Capacity</p>
                            <p className="text-white font-semibold text-xs md:text-sm">1,850</p>
                          </div>
                          <div>
                            <p className="text-[#A8B3B8] text-[10px] md:text-xs mb-1">Avg Ticket</p>
                        ...
                        <div className="space-y-1.5 md:space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-[#A8B3B8] text-[10px] md:text-xs">Projected Revenue</span>
                            <span className="text-white font-semibold text-xs md:text-sm">$83,250</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-[#A8B3B8] text-[10px] md:text-xs">Total Expenses</span>
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-[#C4FF0D] font-bold text-base md:text-lg">$20,850</span>
                          </div>
                          <div className="w-full bg-gray-700 rounded-full h-1.5 md:h-2 mt-1.5 md:mt-2 overflow-hidden">
                            <div
                              className="bg-[#C4FF0D] h-1.5 md:h-2 rounded-full transition-all duration-1000 ease-out"
                              style={{ width: `${progressWidth}%` }}
                            ></div>
                          </div>
                          <p className="text-[#A8B3B8] text-[10px] md:text-xs">75% to break-even</p>
                        </div>
                      </div>
                    </div>

                    <div className="lg:col-span-5 space-y-2 md:space-y-3">
                      <div className="bg-gradient-to-br from-[#C4FF0D]/20 to-[#C4FF0D]/5 rounded-lg md:rounded-xl p-3 md:p-4 border-2 border-[#C4FF0D]/40 animate-[pulse_2s_ease-in-out_infinite]">
                        <div className="flex items-center gap-1.5 md:gap-2 mb-2 md:mb-3">
                          <Target className="h-3 w-3 md:h-4 md:w-4 text-[#C4FF0D]" />
                          <span className="text-[#C4FF0D] font-bold text-[10px] md:text-xs">DEAL SCORE</span>
                        </div>
                        <div className="flex items-end gap-1.5 md:gap-2 mb-2">
                          <span className="text-3xl md:text-5xl font-bold text-[#C4FF0D] transition-all duration-300">
                            {dealScore}
                          </span>
                          <span className="text-[#A8B3B8] text-xs md:text-sm mb-1 md:mb-2">/100</span>
                        </div>
                        <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-1.5 md:py-2 bg-[#C4FF0D] rounded-lg animate-[bounce_1s_ease-in-out_2s]">
                          <TrendingUp className="h-3 w-3 md:h-4 md:w-4 text-black" />
                          <span className="text-black font-bold text-xs md:text-sm">STRONG BUY</span>
                        </div>
                      </div>

                      <div className="bg-[#1A1D1F] rounded-lg md:rounded-xl p-3 md:p-4 border border-gray-700 space-y-2 md:space-y-3">
                        <div className="flex items-center gap-1.5 md:gap-2">
                          <Award className="h-3 w-3 md:h-4 md:w-4 text-[#C4FF0D]" />
                        ...
                        <div className="space-y-1.5 md:space-y-2">
                          <div className="flex items-start gap-1.5 md:gap-2">
                            ...
                            <p className="text-[#A8B3B8] text-[10px] md:text-xs">This venue has 92% sell-through rate</p>
                          </div>
                          <div className="flex items-start gap-1.5 md:gap-2">
                            <CheckCircle2 className="h-2.5 w-2.5 md:h-3 md:w-3 text-green-400 mt-0.5 flex-shrink-0" />
                            <p className="text-[#A8B3B8] text-[10px] md:text-xs">Strong profit margin at 25%</p>
                          </div>
                          <div className="flex items-start gap-1.5 md:gap-2">
                            <Clock className="h-2.5 w-2.5 md:h-3 md:w-3 text-yellow-400 mt-0.5 flex-shrink-0" />
                            <p className="text-[#A8B3B8] text-[10px] md:text-xs">Similar shows avg 78% capacity</p>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white leading-tight">
              ...
              <br />
              <span className="bg-gradient-to-r from-[#C4FF0D] to-[#A3D60A] bg-clip-text text-transparent">
                PROMTP Saves It.
              </span>
            </h2>
            <p className="text-lg text-[#A8B3B8] max-w-2xl mx-auto">
              Every miscalculation, missed detail, or last-minute scramble chips away at your profit.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-8 bg-[#252A2E] border border-gray-800 rounded-2xl hover:border-[#C4FF0D]/50 transition-all hover:scale-105 animate-[fadeIn_0.6s_ease-out]">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#C4FF0D]/10 rounded-xl">
                  <CheckCircle2 className="h-6 w-6 text-[#C4FF0D]" />
                </div>
                <div>
            ...
            <div className="p-8 bg-[#252A2E] border border-gray-800 rounded-2xl hover:border-[#C4FF0D]/50 transition-all hover:scale-105 animate-[fadeIn_0.6s_ease-out_0.1s_both]">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#C4FF0D]/10 rounded-xl">
                  <CheckCircle2 className="h-6 w-6 text-[#C4FF0D]" />
                </div>
            ...
            <div className="p-8 bg-[#252A2E] border border-gray-800 rounded-2xl hover:border-[#C4FF0D]/50 transition-all hover:scale-105 animate-[fadeIn_0.6s_ease-out_0.2s_both]">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#C4FF0D]/10 rounded-xl">
                  <CheckCircle2 className="h-6 w-6 text-[#C4FF0D]" />
                </div>
            ...
            <div className="p-8 bg-[#252A2E] border border-gray-800 rounded-2xl hover:border-[#C4FF0D]/50 transition-all hover:scale-105 animate-[fadeIn_0.6s_ease-out_0.3s_both]">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#C4FF0D]/10 rounded-xl">
                  <CheckCircle2 className="h-6 w-6 text-[#C4FF0D]" />
                </div>
      ...
      <section className="py-20 px-6 bg-[#0F1113]">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#C4FF0D]/10 rounded-full mb-6">
              <div className="w-2 h-2 bg-[#C4FF0D] rounded-full animate-pulse"></div>
              <span className="text-[#C4FF0D] font-bold text-sm tracking-wide">HOW IT WORKS</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white leading-tight">
              From Deal → Profit, in Minutes
            </h2>
            <p className="text-base text-[#A8B3B8]">
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex-shrink-0">
                <div className="w-14 h-14 bg-[#C4FF0D] rounded-xl flex items-center justify-center text-2xl font-bold text-black">
                  1
                </div>
              </div>
              <div className="flex-1 bg-[#252A2E] border border-gray-800 rounded-xl p-5 hover:border-[#C4FF0D]/30 transition-colors">
                <h3 className="text-xl font-bold text-white mb-2">Create the Offer</h3>
                <p className="text-[#A8B3B8] text-sm leading-relaxed mb-3">
                  Enter the artist, venue, date, and deal type. PROMTP calculates break-even, fees, and profit automatically.
                </p>
                <div className="flex items-center gap-2 text-[#C4FF0D] text-sm font-bold">
            ...
            >
              ...
              <div className="flex-1 bg-[#252A2E] border border-gray-800 rounded-xl p-5 hover:border-[#C4FF0D]/30 transition-colors relative">
                <div className="absolute top-3 right-3">
                  <span className="px-2.5 py-1 bg-[#C4FF0D] text-black text-xs font-bold rounded">PRO</span>
                </div>
      ...
      <section className="py-20 px-6 bg-[#1A1D1F]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#A8B3B8]">Be honest 👇</p>
          </div>

          <div className="bg-gradient-to-br from-[#252A2E] to-[#1A1D1F] border-2 border-[#C4FF0D]/30 rounded-3xl p-8 md:p-12">
              ...
              {[
                ...
                <label key={index} className="flex items-start gap-4 cursor-pointer group">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-6 h-6 border-2 border-gray-600 rounded group-hover:border-[#C4FF0D] transition-colors flex items-center justify-center">
                      <div className="w-3 h-3 bg-[#C4FF0D] rounded opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </div>
                  </div>
                  <span className="text-white text-lg group-hover:text-[#C4FF0D] transition-colors">{item}</span>
                </label>
              ))}
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-gray-700 text-center">
              <p className="text-xl md:text-2xl font-bold text-white mb-6">
                If you checked even <span className="text-[#C4FF0D]">one</span>:
              </p>
              ...
              <button
                onClick={() => navigate('/signup')}
                className="px-8 py-4 bg-[#C4FF0D] text-black font-bold text-lg rounded-xl hover:bg-[#A3D60A] transition-all hover:scale-105 shadow-lg shadow-[#C4FF0D]/20"
              >
                Start Free Trial
              </button>
            </div>
      ...
      <section id="features" className="py-20 px-6 bg-[#0F1113]">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-[#252A2E] border border-gray-800 rounded-2xl hover:border-[#C4FF0D]/50 transition-all">
              <div className="w-12 h-12 bg-[#C4FF0D]/10 rounded-xl flex items-center justify-center mb-4">
                <FileText className="h-6 w-6 text-[#C4FF0D]" />
              </div>
            ...
            <div className="p-6 bg-[#252A2E] border border-gray-800 rounded-2xl hover:border-[#C4FF0D]/50 transition-all">
              <div className="w-12 h-12 bg-[#C4FF0D]/10 rounded-xl flex items-center justify-center mb-4">
                <DollarSign className="h-6 w-6 text-[#C4FF0D]" />
              </div>
            ...
            <div className="p-6 bg-gradient-to-br from-[#C4FF0D]/10 to-[#C4FF0D]/5 border-2 border-[#C4FF0D]/50 rounded-2xl">
              <div className="flex items-center justify-between mb-4">
                <div className="w-12 h-12 bg-[#C4FF0D] rounded-xl flex items-center justify-center">
            ...
            <div className="p-6 bg-[#252A2E] border border-gray-800 rounded-2xl hover:border-[#C4FF0D]/50 transition-all">
              <div className="w-12 h-12 bg-[#C4FF0D]/10 rounded-xl flex items-center justify-center mb-4">
                <Upload className="h-6 w-6 text-[#C4FF0D]" />
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="p-8 bg-[#252A2E] border border-gray-800 rounded-2xl hover:border-gray-700 transition-all">
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2 mb-6">
                  ...
                  <span className="text-[#A8B3B8]">/mo</span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mt-0.5 flex-shrink-0" />
                  <span className="text-sm text-[#A8B3B8]">1 seat</span>
                </div>
                <div className="flex items-start gap-3">
            ...
            <div className="p-8 bg-gradient-to-br from-[#C4FF0D]/20 to-[#C4FF0D]/5 border-2 border-[#C4FF0D] rounded-2xl relative transform scale-105 shadow-2xl shadow-[#C4FF0D]/20">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2 mb-6">
                  <span className="text-5xl font-bold text-[#C4FF0D]">$99</span>
                  <span className="text-[#A8B3B8]">/mo</span>
                </div>
              </div>
              ...
              <button
                onClick={() => navigate('/signup')}
                className="w-full mb-6 bg-[#C4FF0D] hover:bg-[#A3D60A] text-black py-4 rounded-xl font-bold transition-colors"
              >
                Start Trial
              </button>
      ...
      <section className="py-20 px-6 bg-[#0F1113]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#C4FF0D]/10 rounded-full mb-6">
              <BarChart3 className="h-4 w-4 text-[#C4FF0D]" />
              <span className="text-[#C4FF0D] font-semibold text-sm">PLANS & FEATURES</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">
              What You Get
            </h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-[#1A1D1F] rounded-2xl border border-gray-800 overflow-hidden">
              <thead className="bg-[#252A2E]">
                <tr>
                  ...
                  <th className="px-6 py-4 text-center text-white font-bold border-b border-gray-800 bg-[#C4FF0D]/10">
                    <div className="flex items-center justify-center gap-2">
                      <span>Pro</span>
                      <span className="px-2 py-0.5 bg-[#C4FF0D] text-black text-xs font-bold rounded">POPULAR</span>
                    </div>
                  </th>
              ...
              <tbody>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">Active Events</td>
                  <td className="px-6 py-4 text-center text-white">10</td>
                  <td className="px-6 py-4 text-center text-white bg-[#C4FF0D]/5">Unlimited</td>
                  <td className="px-6 py-4 text-center text-white">Unlimited</td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">Seats</td>
                  <td className="px-6 py-4 text-center text-white">1</td>
                  <td className="px-6 py-4 text-center text-white bg-[#C4FF0D]/5">2</td>
                  <td className="px-6 py-4 text-center text-white">5+</td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">Offer Builder + PDFs</td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-[#C4FF0D]/5"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">Settlement Tracking</td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-[#C4FF0D]/5"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">Dashboard + Calendar</td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-[#C4FF0D]/5"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">Imports (CSV / PDF)</td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-[#C4FF0D]/5"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">Tour Management</td>
                  <td className="px-6 py-4 text-center"><X className="h-5 w-5 text-gray-600 mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-[#C4FF0D]/5"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">AI Deal Analyzer</td>
                  <td className="px-6 py-4 text-center"><X className="h-5 w-5 text-gray-600 mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-[#C4FF0D]/5"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="px-6 py-4 text-[#A8B3B8]">Advanced AI</td>
                  <td className="px-6 py-4 text-center"><X className="h-5 w-5 text-gray-600 mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-[#C4FF0D]/5"><X className="h-5 w-5 text-gray-600 mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><CheckCircle2 className="h-5 w-5 text-[#C4FF0D] mx-auto" /></td>
                </tr>
                <tr>
                  <td className="px-6 py-4 text-[#A8B3B8] font-semibold">Status</td>
                  <td className="px-6 py-4 text-center">
                    <span className="inline-block px-3 py-1 bg-green-500/20 text-green-400 text-xs font-bold rounded-full">Live</span>
                  </td>
                  <td className="px-6 py-4 text-center bg-[#C4FF0D]/5">
                    <span className="inline-block px-3 py-1 bg-green-500/20 text-green-400 text-xs font-bold rounded-full">Live</span>
                  </td>
                  <td className="px-6 py-4 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="bg-[#252A2E] border border-gray-800 rounded-xl overflow-hidden hover:border-[#C4FF0D]/30 transition-colors">
                <details className="group">
                  <summary className="px-6 py-5 flex items-center justify-between cursor-pointer list-none">
                    <h3 className="text-lg font-semibold text-white pr-4">{faq.question}</h3>
                    <ChevronDown className="h-5 w-5 text-[#C4FF0D] flex-shrink-0 transition-transform group-open:rotate-180" />
                  </summary>
          ...
          <div className="mt-12 text-center">
            <p className="text-[#A8B3B8] mb-4">Have more questions?</p>
            <Link
              to="/faq"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#252A2E] border border-gray-800 hover:border-[#C4FF0D]/50 text-white rounded-lg transition-colors"
            >
              View All FAQs
            </Link>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-[#C4FF0D] to-[#A3D60A]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-black/70">
            <div className="flex items-center gap-1.5">
      ...
      <section className="py-16 px-6 bg-[#0F1113] border-t border-gray-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <button
            onClick={() => navigate('/signup')}
            className="px-10 py-5 bg-[#C4FF0D] text-black font-bold text-xl rounded-xl hover:bg-[#A3D60A] transition-all hover:scale-105 shadow-lg shadow-[#C4FF0D]/20 mb-6"
          >
            Start Free Trial →
          </button>
          <div className="flex flex-wrap items-center justify-center gap-3 text-sm text-[#A8B3B8]">
            <div className="flex items-center gap-1.5">
              <CheckCircle2 className="h-4 w-4 text-[#C4FF0D]" />
              <span>7-day free trial</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-[#A8B3B8]">
                <li><Link to="/privacy" className="hover:text-[#C4FF0D] transition-colors">Privacy</Link></li>
                <li><Link to="/terms" className="hover:text-[#C4FF0D] transition-colors">Terms</Link></li>
                <li><Link to="/security" className="hover:text-[#C4FF0D] transition-colors">Security</Link></li>
                <li><Link to="/faq" className="hover:text-[#C4FF0D] transition-colors">FAQ</Link></li>
              </ul>
            </div>
          </div>
