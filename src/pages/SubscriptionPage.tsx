    ...
    <div className="min-h-screen bg-[#1140F0]">
      <div className="bg-[#14171E] border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
          <div className="w-20 h-20 bg-[#8FD3FF] rounded-2xl flex items-center justify-center mx-auto mb-6">
            <CreditCard className="h-10 w-10 text-[#04214D]" />
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {STRIPE_PRODUCTS.map((product, index) => {
              ...
              return (
                <div
                  key={product.id}
                  className={`bg-[#14171E] rounded-3xl p-8 transition-all ${
                    isPopular
                      ? 'border-4 border-[#8FD3FF] shadow-2xl shadow-[#8FD3FF]/20 relative'
                      : 'border-2 border-gray-800 hover:shadow-2xl hover:border-gray-700'
                  }`}
                >
                  {isPopular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-[#8FD3FF] text-[#04214D] px-4 py-1 text-sm font-bold rounded-full">
                      RECOMMENDED
                    </div>
                  )}
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className={`text-5xl font-bold mb-2 ${isPopular ? 'text-[#8FD3FF]' : 'text-white'}`}>
                      ${product.price}
                    </div>
                  ...
                  <div className="space-y-4 mb-8">
                    {product.description?.split('\n').map((feature, idx) => (
                      <div key={idx} className="flex items-start gap-3">
                        <Check className="h-5 w-5 text-[#8FD3FF] flex-shrink-0 mt-0.5" />
        ...
        <div className="bg-gradient-to-r from-[#14171E] to-[#22262F] border border-gray-800 rounded-3xl p-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-[#0B0D12] border border-gray-800 rounded-xl p-4 sm:p-6">
              <div className="bg-[#14171E] rounded-lg border border-gray-700 p-4 sm:p-6">
                <div className="flex items-start justify-between mb-4 pb-4 border-b border-gray-700">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#8FD3FF]/10 rounded-lg flex items-center justify-center">
                      <Music className="h-5 w-5 text-[#8FD3FF]" />
                    </div>
                    <div>
                  ...
                  <div className="px-2 py-1 bg-[#8FD3FF]/10 rounded text-[10px] font-semibold text-[#8FD3FF]">
                    DRAFT
                  </div>
                </div>

                <div className="space-y-3">
                  <div className="bg-[#22262F] rounded-lg p-3 border border-gray-700">
                    ...
                    <div className="space-y-2 pt-2 border-t border-gray-700">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-1">
                          <TrendingUp className="h-3 w-3 text-[#8FD3FF]" />
                          <span className="text-sm font-bold text-[#8FD3FF]">$27,500</span>
                        </div>
                      </div>
                    </div>
                  </div>

                  <div className="bg-gradient-to-br from-[#8FD3FF]/10 to-[#8FD3FF]/5 rounded-lg p-3 border border-[#8FD3FF]/30">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-[10px] text-[#8FD3FF] font-semibold mb-1">PROFIT MARGIN</p>
                        <p className="text-xl font-bold text-[#8FD3FF]">27.5%</p>
                      </div>
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-1.5 mt-2">
                      <div className="bg-[#8FD3FF] h-1.5 rounded-full" style={{ width: '72%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
